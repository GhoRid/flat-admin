...
export const getSearchMonth = (value: unknown, fallback = new Date()) =>
  typeof value === "string" && parseYYYYMMToDate(value) ? value : formatToYYYYMM(fallback);

export const getSearchDate = (value: unknown, fallback = new Date()) =>
  typeof value === "string" && parseYYYYMMDDToDate(value) ? value : formatToYYYYMMDD(fallback);
